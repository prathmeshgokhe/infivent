      ...
      <div className="solution-content">
        <div className="grid-container">
          ...
          <div className="card">
            ...
            <ul>
              <li>
                - Customizable registration forms with a form builder for
                attendee data collection.
              </li>
              <li>
                - Online attendee registration, ticketing, and payment
                processing.
              </li>
          ...
          <div className="card">
            ...
            <ul>
              ...
              <li>
                - Lead retrieval and exhibitor analytics for better ROI
                tracking.
              </li>
          ...
          <div className="card">
            ...
            <ul>
              ...
              <li>
                - Session management and agenda creation with a schedule
                builder.
              </li>
              <li>
                - Speaker profiles and presentation materials integration.
              </li>
            </ul>
          </div>
          <div className="card">
          ...
          <div className="card">
            ...
            <ul>
              ...
              <li>
                - API access for data syncing and third-party integrations
              </li>
            </ul>
          </div>
          <div className="card">
